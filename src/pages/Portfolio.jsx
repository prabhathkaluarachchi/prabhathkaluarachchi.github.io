...
function Portfolio() {
        ...
        <div className="container">
          ...
          >
            ...
            >
              ...
              <li data-filter=".filter-code">Programming</li>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
                <div className="portfolio-content h-100">
                  ...
                  <div className="portfolio-info">
                    ...
                    <p>
                      Built using Bootstrap 5, HTML, CSS, and JavaScript, these
                      projects highlight my ability to create responsive,
                      user-friendly designs and interactive interfaces.
                    </p>
                    <a
                      href="assets/img/portfolio/app-1.jpg"
                      title="Prabhath Kaluarachchi Portfolio Website"
  ...
  A modern MERN (MongoDB, Express, React, Node.js) full-stack learning and internship management platform powered by Gemini AI, enabling students to develop skills through interactive courses while helping administrators manage learning, analytics, and AI-based candidate screening efficiently.
              ...
              <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
                <div className="portfolio-content h-100">
                  ...
                  <div className="portfolio-info">
                    ...
                    <p>
                      A web-based medical appointment system that optimizes the
                      scheduling workflow for both healthcare providers and
                      patients. Built using Node Js, Express Js, Ejs, Bootstrap,
                      and MongoDB.
                    </p>
                    <a
                      href="assets/img/portfolio/medi.png"
                      title="MediMate Medical Appointment Booking System"
                      data-gallery="portfolio-gallery-web"
                      className="glightbox preview-link"
                    >
                      <i className="bi bi-zoom-in"></i>
                    ...
                    <a
                      href="https://github.com/MediMateBooking/MediMateProject"
                      target="_blank"
                      title="MediMate Medical Appointment Booking System"
                      className="details-link"
                    >
              ...
              <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-code">
                <div className="portfolio-content h-100">
                  <img
                    src="assets/img/portfolio/librisync.jpg"
                    className="img-fluid"
                    alt=""
                  />
                  <div className="portfolio-info">
                    <h4>Library Management System - LibriSync</h4>
                    <p>
                      LibriSync is a powerful Python-based system designed to
                      organize and manage all your educational resources in one
                      place. The frontend is built using React.js and Vite,
                      while the backend is fully powered by Python.
                    </p>
                    <a
                      href="assets/img/portfolio/librisync.jpg"
                      title="LibriSync - Library Management System"
                      data-gallery="portfolio-gallery-code"
                      className="glightbox preview-link"
                    >
                      <i className="bi bi-zoom-in"></i>
                    </a>
                    <a
                      href="https://prabhathkaluarachchi.github.io/LibriSyncFrontend/"
                      target="_blank"
                      title="LibriSync - Library Management System"
                      className="details-link"
                    >
              ...
              <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-uiux">
                <div className="portfolio-content h-100">
                  <img
                    src="assets/img/portfolio/lolc.jpeg"
                    className="img-fluid"
                    alt=""
                  />
                  <div className="portfolio-info">
                    ...
                    <p>
                      Prototyping and designing responsive screens in Figma,
                      focusing on and fixing bad experiences of the existing
                      app.
                    </p>
                    <a
                      href="assets/img/portfolio/lolc.jpeg"
              ...
              <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
                <div className="portfolio-content h-100">
                  ...
                  <div className="portfolio-info">
                    ...
                    <p>
                      Fully functional E-commerce website. Includes order
                      management, user management, contact forms, a secure
                      payment gateway, and seamless WooCommerce product
                      management.
                    </p>
                    <a
                      href="assets/img/portfolio/app-2.jpg"
                      title="Radee Online Shopping Website - WordPress"
                      data-gallery="portfolio-gallery-web"
                      className="glightbox preview-link"
                    >
                      <i className="bi bi-zoom-in"></i>
                    ...
                    <a
                      href="https://radeeshop.wuaze.com/"
                      target="_blank"
                      title="Radee Online Shopping Website - WordPress"
                      className="details-link"
                    >
              ...
              <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
                <div className="portfolio-content h-100">
                  ...
                  <div className="portfolio-info">
                    ...
                    <p>
                      Here portfolio website for Carrie Collins to publish their
                      books. Includes Portfolio, Newsletter, Upcoming Events,
                      Contact Forms and Backup Security Management.
                    </p>
                    <a
                      href="assets/img/portfolio/app-4.jpg"
                      title="Carrie Collins Author Website - WordPress"
                      data-gallery="portfolio-gallery-web"
                      className="glightbox preview-link"
                    >
                      <i className="bi bi-zoom-in"></i>
                    ...
                    <a
                      href="https://carriecollinswrites.wpcomstaging.com/"
                      target="_blank"
                      title="Carrie Collins Author Website - WordPress"
                      className="details-link"
                    >
              ...
              <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-uiux">
                <div className="portfolio-content h-100">
                  <img
                    src="assets/img/portfolio/lms.jpeg"
                    className="img-fluid"
                    alt=""
                  />
                  <div className="portfolio-info">
                    <h4>LMS App UI/UX</h4>
                    <p>
                      Designed a responsive LMS app prototype in Figma, focused
                      on delivering an intuitive and seamless user experience
                      for learners and educators.
                    </p>
                    <a
                      href="assets/img/portfolio/lms.jpeg"
                      title="Responsive LMS app prototype in Figma"
                      data-gallery="portfolio-gallery-uiux"
                      className="glightbox preview-link"
                    >
                      <i className="bi bi-zoom-in"></i>
              ...
              <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
                <div className="portfolio-content h-100">
                  ...
                  <div className="portfolio-info">
                    ...
                    <p>
                      A website showcasing an extensive collection of Sri Lankan
                      stamps! Dive into a visually engaging display that
                      highlights the unique designs and historical significance
                      of each stamp.
                    </p>
                    <a
                      href="assets/img/portfolio/app-3.jpg"
                      title="Responsive SL Stamps Collection Website"
                      data-gallery="portfolio-gallery-web"
                      className="glightbox preview-link"
                    >
                      <i className="bi bi-zoom-in"></i>
                    ...
                    <a
                      href="https://prabhathkaluarachchi.github.io/slstamps/"
                      target="_blank"
                      title="More Details"
                      className="details-link"
                    >
